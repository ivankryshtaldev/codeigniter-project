				...
				<div class="card main_card">
					<div class="card-header" style="border-bottom: 0;padding-bottom:0 !important;">
						<ul class="nav nav-tabs" role="tablist" style="width:100% !important">
							<li class="nav-item">
								<a id="text_post" class="nav-link post_type" data-toggle="tab" href="#textPost" role="tab" aria-selected="false"><?php echo $this->lang->line('Text') ?></a>
							</li>              
							<li class="nav-item">
								<a id="link_post" class="nav-link post_type" data-toggle="tab" href="#linkPost" role="tab" aria-selected="true"> <?php echo $this->lang->line("Link") ?></a>
							</li>
							<li class="nav-item">
								<a id="image_post" class="nav-link post_type" data-toggle="tab" href="#imagePost" role="tab" aria-selected="false"><?php echo $this->lang->line("Image/Multi-Images"); ?></a>
							</li>
							<li class="nav-item">
								<a id="video_post" class="nav-link post_type" data-toggle="tab" href="#videoPost" role="tab" aria-selected="false"><?php echo $this->lang->line("Video"); ?></a>
							</li>
						</ul>
					</div>
			          	...
			          	<div class="tab-content" id="post_tab_content">
							<form action="#" enctype="multipart/form-data" id="edit_poster_form" method="post">
								...
								<div class="row">
									...
									<?php if ($facebook_poster_group != '0'): ?>
								...
								<div class="card-footer padding-0">
									...
									<button class="btn btn-primary btn-lg" submit_type="text_submit" id="submit_post" name="submit_post" type="button"><i class="fas fa-edit"></i> <?php echo $this->lang->line("Submit Post");?></button>
...
<script>
	...
	$("document").ready(function(){
		...
		// var scheduleType = '<?php echo $all_data[0]['schedule_type'];?>';
		// if(scheduleType == 'later')
		// {
		// 	$("input[name=schedule_type]").removeAttr('checked')
		// 	$(".schedule_block_item").show();
		// } else 
		// {
		// 	$("input[name=schedule_type]").attr('checked');
