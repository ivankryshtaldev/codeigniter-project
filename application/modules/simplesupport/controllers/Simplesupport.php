...
class Simplesupport extends Home
{
    ...
    public function reply_action()
    {
       ...
       // if($this->session->userdata("user_type")!="Admin") $update_ticket = array("last_replied_at"=>date("Y-m-d H:i:s"),"last_replied_by"=>$this->user_id,"ticket_status"=>"1","display"=>"1");
       // else $update_ticket = array("last_replied_at"=>date("Y-m-d H:i:s"),"last_replied_by"=>$this->user_id);
