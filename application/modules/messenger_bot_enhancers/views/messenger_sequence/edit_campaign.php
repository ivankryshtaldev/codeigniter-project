  ...
  <div class="modal-dialog" style="max-width:100%;margin:0px;">
    <div class="modal-content <?php if($iframe=='1') echo 'no_shadow';?>">
              ...
              <div class="card border_me">
                ...
                <div class="card-body">
                 ...
                 <ul class="nav nav-tabs" id="sequence_tab" role="tablist">
                   ...
                   <li class="nav-item">
                     <a class="nav-link active" id="sequence_tab2" data-toggle="tab" href="#hourwise" role="tab" aria-controls="profile" aria-selected="false"><?php echo  $this->lang->line("24 Hour Promotional"); ?></a>
                   </li>
                   <li class="nav-item">
                   ...
                   <div class="tab-pane fade" id="daywise" role="tabpanel" aria-labelledby="sequence_tab1">
                     <div class="row">
                       ...
                       <div class="col-6 col-md-3">
                           ...
                           <?php echo form_dropdown('timezone', $timezones,$selcted_timezone,"class='form-control select2' id='timezone'");?>
                           </div>
                       </div>
                       <div class="col-6 col-md-3">
                         <div class="form-group">                
                     ...
                     <div class="row button_container">
                       ...
                       <div class="form-group col-2">
                         <a target="_BLANK" title="<?php echo $this->lang->line('Add New Template');?>" data-toggle="tooltip" class="btn btn-default btn-lg add_template"  href="<?php echo base_url('messenger_bot/create_new_template/1/'.$page_auto_id);?>"><i class="fas fa-plus-circle"></i></a>
                       </div>
                     </div>
                   </div>
      ...
      <div class="modal-footer <?php if($iframe=='1') echo 'padding-0';?>">
         ...
         <a href="<?php echo base_url('messenger_bot_enhancers/sequence_message_campaign/'.$page_auto_id.'/1'); ?>" class="btn btn-lg btn-secondary float-right"><i class="fas fa-times"></i> <?php echo $this->lang->line('Back');?></a>             
  ...
  $("document").ready(function(){
    ...
    $(document).on('click','#submit_btn',function(e){
      ...
      $.ajax({
        context : this,
        type:'POST' ,
        url: base_url+"messenger_bot_enhancers/edit_sequence_message_campaign_action",
        data: queryString,
        dataType : 'JSON',
        // async: false,
        cache: false,
        ...
        success:function(response){
          if(response.status=='1')
          {
            swal('<?php echo $this->lang->line("Campaign Updated"); ?>', response.message, 'success').then((value) => {
              window.location.assign("<?php echo base_url('messenger_bot_enhancers/sequence_message_campaign/'.$page_auto_id.'/1');?>");
            });
          }
