  ...
  <div class="modal-dialog modal-full">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<?php if(strtotime(date("Y-m-d")) <= strtotime("2020-1-15")) : ?> <h5 class="text-center text-primary">NEW TAGS</h5><br> <?php endif; ?>
      	...
      	<?php if(strtotime(date("Y-m-d")) <= strtotime("2020-1-15")) : ?>
      	<br><br><br><br>
      	<h5 class="text-center text-danger">SUPPORTED UNTIL JAN 15, 2020</h5><br>
      	<div class="table-responsive2">
	        <table class="table table-bordered table-striped">
	           <thead>
	              <tr>
