      ...
      $(document).on('click','#submit',function(e){   
        ...
        for(var m=1; m<=multiple_template_add_button_counter; m++)
        {
          ...
          if(template_type == 'text')
          {
            ...
            if(text_reply == ''){
              swal('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please provide your message')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "image")
          {
            ...
            if(image_reply_field == ''){
              swal('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please provide your image')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "audio")
          {
            ...
            if(audio_reply_field == ''){
              swal('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please provide your audio')?>", 'warning');
              return;
            }
          }
          ...
          if(template_type == "video")
          {
            ...
            if(video_reply_field == ''){
              swal('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please provide your video')?>", 'warning');
              return;          
            }
          }
          ...
          if(template_type == "file")
          {
            ...
            if(file_reply_field == ''){
              swal('<?php echo $this->lang->line("Warning"); ?>', "<?php echo $this->lang->line('Please provide your file')?>", 'warning');
              return;          
            }
          }
...
<style type="text/css">
  ...
  .css-label-container{padding:10px;border:1px dashed #ccc;border-radius: 5px;}
  .img_holder img{
