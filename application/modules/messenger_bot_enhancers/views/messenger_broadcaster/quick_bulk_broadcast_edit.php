...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active"><a href="<?php echo base_url('messenger_bot_enhancers/quick_broadcast_campaign'); ?>"><?php echo $this->lang->line("Quick Broadcast");?></a></div>
...
<div class='text-center' style='padding:12px;border:.5px solid #dee2e6; color:#6777ef;background: #fff;'><?php echo $this->lang->line("The limit of reach per campaign is 10K set by Facebook. If the estimated reach exceeds 10K, create campaign by selecting label to segment the campaign."); ?><br> <?php echo $this->lang->line("Message should not contain any advertisement or promotional material."); ?></div>
<div class="row multi_layout">  
      ...
      <div class="card main_card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4"> 
              <div class="form-group">
                <label><?php echo $this->lang->line("Notification Type"); ?> <a data-html="true" href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("Notification Type") ?>" data-content="<?php echo $this->lang->line('Regular Push notification will make a sound and display a phone notification. Use it for important messages.');?><br><br><?php echo $this->lang->line('Silent Push notification will display a phone notification without sound. Use it for regular messages that do not require immediate action.');?><br><br><?php echo $this->lang->line('No push will not display any notification. Use it for silently sending content updates.');?>">&nbsp;&nbsp;<i class='fa fa-info-circle'></i> </a></label>
                <select class="form-control" id="notification_type" name="notification_type">
                  <option value="REGULAR" <?php if($xdata['notification_type']=='REGULAR') echo 'selected';?>>REGULAR</option>
                  <option value="SILENT_PUSH" <?php if($xdata['notification_type']=='SILENT_PUSH') echo 'selected';?>>SILENT PUSH</option>
                  <option value="NO_PUSH" <?php if($xdata['notification_type']=='NO_PUSH') echo 'selected';?>>NO PUSH</option>
                </select>                    
              </div>       
            </div> 
          ...
          <div class="row hidden" id="dropdown_con">
           ...
           <?php 
           for($k=1;$k<=1;$k++){ 
             $full_message[$k] = isset($full_message_array['messages'][0]) ? $full_message_array['messages'][0] : array();
  ...
  <script type="text/javascript">
    ...
    function display_error_message(content)
    {
  ...
  <?php for($template_type=1;$template_type<=1;$template_type++){ ?>
    ...
    <?php endfor; ?>
        ...
        $(document).on('click',"#quick_reply_add_button_<?php echo $template_type; ?>",function(e){
          ...
          {        
            if(quick_reply_post_id_check == ''){
              display_error_message("<?php echo $this->lang->line('Please Provide Your PostBack Id')?>");
          ...
          {
            display_error_message("<?php echo $this->lang->line('Please Provide Your Button Type')?>");
          ...
          { 
            if(quick_reply_button_text_check == ''){
              display_error_message("<?php echo $this->lang->line('Please Provide Your Button Text')?>");
       ...
       $(document).on('click',"#text_with_button_add_button_<?php echo $template_type; ?>",function(e){
          ...
          if(text_with_button_type_check == ''){
            ...
            if(text_with_button_web_url_check == ''){
              display_error_message("<?php echo $this->lang->line('Please Provide Your Web Url')?>");
            ...
            if(text_with_button_call_us_check == ''){
              display_error_message("<?php echo $this->lang->line('Please Provide Your Phone Number')?>");
      ...
      $(document).on('click','#carousel_template_add_button_<?php echo $template_type; ?>',function(e){
           ...
           //   display_error_message("<?php echo $this->lang->line('Please provide your reply image')?>");
           //   
           //   return;
           // }
           ...
           if(carousel_title_check == ''){
             display_error_message("<?php echo $this->lang->line('Please Provide carousel title')?>");
          ...
          //   display_error_message("<?php echo $this->lang->line('Please give the sub-title')?>");
          //   
          //   return;
          // }
           ...
           //   display_error_message("<?php echo $this->lang->line('Please Provide Image Click Destination Link')?>");
           //   
           //   return;        
           // }
      ...
      $(document).on('click','#list_template_add_button_<?php echo $template_type; ?>',function(e){
        ...
        if(list_title_check_1 == ''){
          display_error_message("<?php echo $this->lang->line('Please Provide list title')?>");
    ...
    $(document).on('click','#submit',function(e){   
      ...
      {
        display_error_message("<?php echo $this->lang->line('Please select different postback id for each button.')?>");
      ...
      if($("#page").val()==""){
        display_error_message("<?php echo $this->lang->line('Please select a page first')?>");
      ...
      for(var m=1; m<=multiple_template_add_button_counter; m++)
      {
        ...
        if(template_type == 'text')
        {
          ...
          if(text_reply == ''){
            display_error_message("<?php echo $this->lang->line('Please provide your message')?>");
        ...
        if(template_type == "image")
        {
          ...
          if(image_reply_field == ''){
            display_error_message("<?php echo $this->lang->line('Please provide your image')?>");
        ...
        if(template_type == "audio")
        {
          ...
          if(audio_reply_field == ''){
            display_error_message("<?php echo $this->lang->line('Please provide your audio')?>");
        ...
        if(template_type == "video")
        {
          ...
          if(video_reply_field == ''){
            display_error_message("<?php echo $this->lang->line('Please provide your video')?>");
        ...
        if(template_type == "file")
        {
          ...
          if(file_reply_field == ''){
            display_error_message("<?php echo $this->lang->line('Please provide your file')?>");
        ...
        if(template_type == "media")
        {
          ...
          if(media_input == ''){
            display_error_message("<?php echo $this->lang->line('Please Provide Your Media URL')?>");
          ...
          {
            display_error_message("<?php echo $this->lang->line('Please provide Facebook content URL as Media URL')?>");
        ...
        if(template_type == "generic template")
        {
          ...
          if(generic_template_title == ''){
            display_error_message("<?php echo $this->lang->line('Please give the title')?>");
      ...
      {
        display_error_message("<?php echo $this->lang->line('Please select schedule time/time zone.')?>");
      ...
      var report_link = base_url+"messenger_bot_enhancers/quick_broadcast_campaign";
      var queryString = new FormData($("#messenger_bot_form")[0]);
      $.ajax({
        type:'POST' ,
        url: base_url+"messenger_bot_enhancers/quick_bulk_broadcast_edit_action",
        data: {xid:myid},
        dataType : 'JSON',
        success:function(response){
          if(response.status=='1')
          {
            $.ajax({
              type:'POST' ,
              url: base_url+"messenger_bot_enhancers/quick_bulk_broadcast_add_action",
              data: queryString,
              dataType : 'JSON',
              // async: false,
              cache: false,
