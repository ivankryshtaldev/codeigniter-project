          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6">
              <div class="form-group">                
                ...
                <?php echo form_dropdown('broadcast_type', $broadcast_types, $xdata['broadcast_type'],'class="select2 form-control" id="broadcast_type"'); ?>
              </div>
            </div>
...
<?php for($template_type=1;$template_type<=1;$template_type++){ ?>
  ...
  $(document).on('click','#submit',function(e){   
    ...
    $("input:not([type=hidden])").each(function(){
     ...
     $.ajax({
      type:'POST' ,
      url: base_url+"messenger_bot_enhancers/subscriber_bulk_broadcast_edit_action",
      data: {xid:myid},
      dataType : 'JSON',
