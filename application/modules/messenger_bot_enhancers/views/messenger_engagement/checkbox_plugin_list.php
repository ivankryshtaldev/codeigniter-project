...
<section class="section section_custom">
  <div class="section-header">
    <h1><i class="fas fa-check-square"></i> <?php echo $page_title; ?></h1>
    <div class="section-header-button">
      <a class="btn btn-primary" href="<?php echo base_url("messenger_bot_enhancers/checkbox_plugin_add");?>">
            ...
            <div class="row">
              <div class="col-md-9 col-12">
                <div class="input-group mb-3 float-left" id="searchbox">
                  ...
                  <input type="text" class="form-control" id="search_domain_name" name="search_domain_name" autofocus placeholder="<?php echo $this->lang->line('Search...'); ?>" aria-label="" aria-describedby="basic-addon2">
