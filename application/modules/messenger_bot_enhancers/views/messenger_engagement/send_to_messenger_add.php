...
<section class="section section_custom">
	<div class="section-header">
		<h1><i class="fas fa-forward"></i> <?php echo $page_title; ?></h1>
		<div class="section-header-breadcrumb">
			<div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot'); ?>"><?php echo $this->lang->line("Messenger Bot"); ?></a></div>
			<div class="breadcrumb-item"><a href="<?php echo base_url('messenger_bot_enhancers/send_to_messenger_list'); ?>"><?php echo $this->lang->line("Send to Messenger Plugin"); ?></a></div>
					...
					<div class="card-body">
						...
						<div class="row">
			            	...
			            	<div class="col-12 col-md-6" style="padding: 10px;">
     						...
     						<div class="form-group col-12 col-md-6 display_messsage_block" style='padding:10px;'>
     						  <label>
...
<script>
	...
	$("document").ready(function()	{
		...
		$('#get_plugin_modal').on('hidden.bs.modal', function () {
		   window.location.href = base_url+"messenger_bot_enhancers/send_to_messenger_list";
		});
