...
<section class="section section_custom">
  <div class="section-header">
    ...
    <div class="section-header-button">
      <a class="btn btn-primary" href="<?php echo base_url("messenger_bot_enhancers/mme_link_add");?>">
      ...
      columnDefs: [
          ...
          },
          {
            ...
            render: function( data, type, row, meta )
                 {
                    var embed_js = '<a campaign_id='+row[1]+' class="badge badge-status get_js_embed" title="<?php echo $this->lang->line('Get Embed Code') ?>" style="cursor: pointer;"><i class="fas fa-code"></i> <?php echo $this->lang->line('Js Code'); ?></a> <a campaign_id='+row[1]+' class="badge badge-status get_qr_code" title="<?php echo $this->lang->line('Get QR Code') ?>" style="cursor: pointer;"><i class="fas fa-qrcode"></i> <?php echo $this->lang->line('QR Code'); ?></a>';
                    return embed_js;
                 }
          },
