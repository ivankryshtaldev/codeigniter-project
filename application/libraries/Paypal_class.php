...
class Paypal_class{
	...
	function set_button(){
		...
		$button.= "<form action='{$this->paypal_url}' method='post' style='padding: 0; margin: 0;'>";
			...
			$button.= "<button type='submit' style='background:#FFC439;color:#000' class='btn btn-warning brn-lg'><i class='fab fa-paypal'></i> ".$this->CI->lang->line("Pay with PayPal")."</button>";
