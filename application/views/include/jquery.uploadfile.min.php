    ...
    a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
        ...
        function l(a, t, r) {
            for (var o = 0; o < r.length; o++)
                ...
                <!-- Sajeeb 27.8.19 -->
                if (r[o] && r[o].name) {
                    var img_name = r[o].name
                    if (img_name.match(/<[^>]*>?/gm)) {
                        var exten = r[o].name.split('.').pop();
                        file_name = 'filename.' + exten
                    } else {
                        file_name = r[o].name
                    }
                }
                ...
                g = a.showFileCounter 
                    ? t.fileCounter + a.fileCounterStyle + file_name 
                    : file_name, a.showFileSize && (g += " (" + s(r[o].size) + ")"), w.filename.html(g);
        ...
        var w = e.extend({
            ...
            dragDropStr: "<span><b><i class='fa fa-arrows-alt'></i> <?php echo $this->lang->line('Drag & Drop Files');?></b></span>",
            uploadStr: "<i class='fa fa-cloud-upload-alt'></i> <?php echo $this->lang->line('Upload');?>",
            abortStr: "<i class='fa fa-ban'></i> <?php echo $this->lang->line('Abort');?>",
            cancelStr: "<i class='fa fa-remove'></i> <?php echo $this->lang->line('Cancel');?>",
            deletelStr: "<i class='fa fa-trash'></i> <?php echo $this->lang->line('Delete');?>",
            doneStr: "<i class='fa fa-check-circle'></i> <?php echo $this->lang->line('Done');?>",
            multiDragErrorStr: "<?php echo $this->lang->line('Multiple File Drag & Drop is not allowed.');?>",
            extErrorStr: "<?php echo $this->lang->line('is not allowed. Allowed extensions: ');?>",
            duplicateErrorStr: "<?php echo $this->lang->line('is not allowed. File already exists.');?>",
            sizeErrorStr: "<?php echo $this->lang->line('is not allowed. Allowed Max size: ');?>",
            uploadErrorStr: "<?php echo $this->lang->line('Upload is not allowed');?>",
            maxFileCountErrorStr: " <?php echo $this->lang->line('is not allowed. Maximum allowed files are:');?>",
            downloadStr: "<i class='fa fa-download'></i> <?php echo $this->lang->line('Download');?>",
