...
$custom_module = isset($profile_info[0]["custom_module"]) ? $profile_info[0]["custom_module"] : "";
	          ...
	          <div class="card-body">
	              ...
	              <div class="row">
	                ...
	                <div class="form-group col-md-12 col-12">
	                	<label class="control-label" for=""><i class="fas fa-plug"></i> <?php echo $this->lang->line("Custom Module");?></label>
	                	<input type="text" value="<?php echo $custom_module;?>" name="custom_module" class="form-control">
	                </div>
	              </div>
	          </div>
