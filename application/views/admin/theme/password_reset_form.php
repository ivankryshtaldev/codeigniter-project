      ...
      <div class="card card-primary" >
        ...
        <div class="card-body" id="recovery_form">
          ...
          <form method="POST" action="<?php echo base_url("change_password/reset_password_action"); ?>">
    	      ...
    	      <a class="btn btn-secondary btn-lg float-right" href="<?php echo base_url('member/edit_profile'); ?>"><i class="fas fa-arrow-circle-left"></i>  <?php echo $this->lang->line("Go Back");?></a>
            </div>
