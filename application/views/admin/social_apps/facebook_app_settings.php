...
<script>       
  ...
  $(document).ready(function() {
    ...
    $(document).on('click','.delete_app',function(e){
      e.preventDefault();
      var ifyoudeletethisaccount = "<?php echo $this->lang->line('If you delete this APP then, all the imported Facebook accounts and their Pages and Campaigns will be deleted too corresponding to this APP.'); ?>";
      swal({
