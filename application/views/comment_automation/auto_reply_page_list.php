...
<script>
	...
	$(document).ready(function(){
		...
		$(document).on('click','.enable_auto_commnet',function(){
			...
			$("#private_message_offensive_words").emojioneArea({
				autocomplete: false,
		...
		$(document).on('click','#add_more_button',function(){
			...
			$("#filter_message_"+content_counter).emojioneArea({
				autocomplete: false,
				pickerPosition: "bottom"
			});
		...
		$(document).on('change','input[name=message_type]',function(){    
			if($("input[name=message_type]:checked").val()=="generic")
			{
				...
				$("#generic_message, #generic_message_private").emojioneArea({
					autocomplete: false,
					pickerPosition: "bottom"
				 });
			...
			else 
			{
				...
				$("#comment_reply_msg_1, #filter_message_1, #nofilter_word_found_text, #nofilter_word_found_text_private").emojioneArea({
					autocomplete: false,
					pickerPosition: "bottom"
				});
		...
		$(document).on('change','input[name=edit_message_type]',function(){    
			...
			else 
			{
				...
				$("#edit_comment_reply_msg_1, #edit_filter_message_1, #edit_nofilter_word_found_text, #edit_nofilter_word_found_text_private").emojioneArea({
					autocomplete: false,
					pickerPosition: "bottom"
				});
			}
					...
					<div id="new_template_section">
								...
								<div class="row">								
									<div class="col-12 col-md-6" id="delete_offensive_comment_keyword_div">
										<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
											...
											<textarea class="form-control message" name="delete_offensive_comment_keyword" id="delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions") ?>" style="height:170px !important;"></textarea>
										</div>
									</div>
									<div class="col-12 col-md-6" id="">
										<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
											...
											<textarea class="form-control small-height message" name="private_message_offensive_words" id="private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:140px !important;"></textarea>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row" style="padding: 10px 20px 10px 20px;">
							...
							<div class="col-12" id="generic_message_div" style="display: none;">
								<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 20px;">
									<label>
									...
									<div class="clearfix"></div>					
									<textarea class="form-control message" name="generic_message_private" id="generic_message_private" placeholder="<?php echo $this->lang->line("Type your message here...") ?>" style="height:170px !important;"></textarea>
							...
							<div class="col-12" id="filter_message_div" style="display: none;">
								<?php for ($i=1; $i <= 20 ; $i++) : ?>
										<div class="form-group" id="filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
											<label>
											...
											<div class="clearfix"></div>
											<textarea class="form-control message" name="filter_message_<?php echo $i; ?>" id="filter_message_<?php echo $i; ?>"  placeholder="<?php echo $this->lang->line("Type your message here...") ?>" style="height:170px !important;"></textarea>
								...
								<div class="form-group" id="nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 20px;">
									<label>
									...
									<div class="clearfix"></div>
									<textarea class="form-control message" name="nofilter_word_found_text_private" id="nofilter_word_found_text_private"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
				...
				<div class="row" style="padding: 20px;<?php if(!$commnet_hide_delete_addon) echo "display: none;"; ?> ">
					...
					<div class="col-12 col-md-6" id="edit_delete_offensive_comment_keyword_div">
						<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
							...
							<textarea class="form-control message" name="edit_delete_offensive_comment_keyword" id="edit_delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions") ?>" style="height:170px !important;"></textarea>
						</div>
					</div>
					<div class="col-12 col-md-6" id="">
						<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
							...
							<div class="clearfix"></div>
							<textarea class="form-control small-height message" name="edit_private_message_offensive_words" id="edit_private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:140px !important;"></textarea>
				...
				<div class="row" style="padding: 10px 20px 10px 20px;">
					...
					<div class="col-12" id="edit_generic_message_div" style="display: none;">
						<div class="form-group" style="border: 1px dashed #e4e6fc; padding: 20px;">
							...
							<div class="clearfix"></div>
							<textarea class="form-control message" name="edit_generic_message_private" id="edit_generic_message_private" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
					...
					<?php for($i=1;$i<=20;$i++) :?>
						<div class="form-group" id="edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
							<label>
								<i class="fa fa-tag"></i> <?php echo $this->lang->line("filter word/sentence") ?> <span class="red">*</span>
							...
							<div class="clearfix"></div>
							<textarea class="form-control message" name="edit_filter_message_<?php echo $i; ?>" id="edit_filter_message_<?php echo $i; ?>"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
					...
					<?php endfor; ?>
						...
						<div class="form-group" id="edit_nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 20px;">
							<label>
								<i class="fa fa-envelope"></i> <?php echo $this->lang->line("comment reply if no matching found") ?>
								<a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("message") ?>" data-content="<?php echo $this->lang->line("Write the message,  if no filter word found. If you don't want to send message them, just keep it blank ."); ?>  Spintax example : {Hello|Howdy|Hola} to you, {Mr.|Mrs.|Ms.} {{Jason|Malina|Sara}|Williams|Davis}"><i class='fa fa-info-circle'></i> </a>
							</label>
							...
							<div class="clearfix"></div>
							<textarea class="form-control message" name="edit_nofilter_word_found_text_private" id="edit_nofilter_word_found_text_private"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px !important;"></textarea>
