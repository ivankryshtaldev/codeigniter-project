              ...
              <div class="row">
                <div class="col-12 col-md-6" id="pageresponse_delete_offensive_comment_keyword_div">
                  <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                    ...
                    <textarea class="form-control message" name="pageresponse_delete_offensive_comment_keyword" id="pageresponse_delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions") ?>" style="height:170px !important;"></textarea>
                  </div>
                </div>
                <div class="col-12 col-md-6" id="">
                  <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                    ...
                    <textarea class="form-control message" name="pageresponse_private_message_offensive_words" id="pageresponse_private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:140px !important;"></textarea>
              ...
              <textarea class="form-control message" name="pageresponse_generic_message" id="pageresponse_generic_message" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px;"></textarea>
                ...
                <span class='float-right'> 
                  <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>" data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo $this->lang->line("first name") ?></a>
  			      ...
  			      <div class="clearfix"></div>             
              <textarea class="form-control message" name="pageresponse_generic_message_private" id="pageresponse_generic_message_private" placeholder="<?php echo $this->lang->line("Type your message here...") ?>" style="height:170px;"></textarea>   
          </div>
          </div>
          <div class="col-12" id="pageresponse_filter_message_div" style="display: none;">
            <?php for ($i=1; $i <= 20 ; $i++) : ?>
                <div class="form-group" id="pageresponse_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
                  <label>
				  ...
				  <div class="clearfix"></div>
          <textarea class="form-control message" name="pageresponse_filter_message_<?php echo $i; ?>" id="pageresponse_filter_message_<?php echo $i; ?>"  placeholder="<?php echo $this->lang->line("Type your message here...") ?>" style="height:170px;"></textarea>
            ...
            <div class="form-group" id="pageresponse_nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 20px;">
              <label>
			  ...
			  <div class="clearfix"></div>
              <textarea class="form-control message" name="pageresponse_nofilter_word_found_text_private" id="pageresponse_nofilter_word_found_text_private"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px;"></textarea>
    ...
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
            ...
            <div class="row">
              <div class="col-12 col-md-6" id="pageresponse_edit_delete_offensive_comment_keyword_div">
                <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                  ...
                  <textarea class="form-control message" name="pageresponse_edit_delete_offensive_comment_keyword" id="pageresponse_edit_delete_offensive_comment_keyword" placeholder="<?php echo $this->lang->line("Type keywords here in comma separated (keyword1,keyword2)...Keep it blank for no actions"); ?>" style="height:170px !important;"></textarea>
                </div>
              </div>
              <div class="col-12 col-md-6" id="">
                <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 10px;">
                  <label><i class="fa fa-envelope"></i> <?php echo $this->lang->line("private reply message after deleting offensive comment") ?></label>
                 ...
                 <div class="clearfix"></div>
                  <textarea class="form-control message" name="pageresponse_edit_private_message_offensive_words" id="pageresponse_edit_private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:100px;"></textarea>
        ...
        <div class="row" style="padding: 10px 20px 10px 20px;">
            ...
            <div class="form-group" style="border: 1px dashed #e4e6fc; padding: 20px;">
              ...
              <span class='float-right'> 
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>" data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo $this->lang->line("first name") ?></a>
      			  ...
      			  <div class="clearfix"></div>
              <textarea class="form-control message" name="pageresponse_edit_generic_message_private" id="pageresponse_edit_generic_message_private" placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px;"></textarea>
              
            </div>
          </div>
          <div class="col-12" id="pageresponse_edit_filter_message_div" style="display: none;">
          <?php for($i=1;$i<=20;$i++) :?>
            <div class="form-group" id="pageresponse_edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #e4e6fc; padding: 20px; margin-bottom: 50px;">
              <label>
                <i class="fa fa-tag"></i> <?php echo $this->lang->line("filter word/sentence") ?> <span class="red">*</span>
              ...
              <span class='float-right'> 
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>" data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo $this->lang->line("first name") ?></a>
      			  ...
      			  <div class="clearfix"></div>
              <textarea class="form-control message" name="pageresponse_edit_filter_message_<?php echo $i; ?>" id="pageresponse_edit_filter_message_<?php echo $i; ?>"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px;"></textarea>
          ...
          <?php endfor; ?>
            ...
            <div class="form-group" id="pageresponse_edit_nofilter_word_found_div" style="margin-top: 10px; border: 1px dashed #e4e6fc; padding: 20px;">
              <label>
                <i class="fa fa-envelope"></i> <?php echo $this->lang->line("comment reply if no matching found") ?>
                <a href="#" data-placement="bottom"  data-toggle="popover" data-trigger="focus" title="<?php echo $this->lang->line("message") ?>" data-content="<?php echo $this->lang->line("Write the message,  if no filter word found. If you don't want to send message them, just keep it blank ."); ?>  Spintax example : {Hello|Howdy|Hola} to you, {Mr.|Mrs.|Ms.} {{Jason|Malina|Sara}|Williams|Davis}"><i class='fa fa-info-circle'></i> </a>
              </label>
              ...
              <span class='float-right'> 
                <a title="<?php echo $this->lang->line("You can include #LEAD_USER_FIRST_NAME# variable inside your message. The variable will be replaced by real names when we will send it.") ?>" data-toggle="tooltip" data-placement="top" class='btn-sm lead_first_name button-outline'><i class='fa fa-user'></i> <?php echo $this->lang->line("first name") ?></a>
      			  ...
      			  <div class="clearfix"></div>
              <textarea class="form-control message" name="pageresponse_edit_nofilter_word_found_text_private" id="pageresponse_edit_nofilter_word_found_text_private"  placeholder="<?php echo $this->lang->line("type your message here...") ?>" style="height:170px;"></textarea>
