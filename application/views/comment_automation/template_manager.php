          ...
          <div id="new_template_section">
                ...
                <div class="row">               
                  ...
                  <div class="col-12 col-md-6" id="">
                    <div class="form-group" style="border: 1px dashed #ccc; padding: 10px;">
                      ...
                      <textarea class="small-height message" name="private_message_offensive_words" id="private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:140px !important;"></textarea>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="row" style="padding: 10px 20px 10px 20px;">
              ...
              <div class="col-12" id="filter_message_div" style="display: none;">
                <?php for ($i=1; $i <= 20 ; $i++) : ?>
                    <div class="form-group" id="filter_div_<?php echo $i; ?>" style="border: 1px dashed #ccc; padding: 10px; margin-bottom: 50px;">
                      <label>
...
<div class="modal fade" id="edit_auto_reply_message_modal" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" style="min-width: 70%;">
            ...
            <div class="row" style="padding: 10px 20px 10px 20px;<?php if(!$commnet_hide_delete_addon) echo "display: none;"; ?> ">
              ...
              <div class="col-12 col-md-6" id="">
                <div class="form-group" style="border: 1px dashed #ccc; padding: 10px;">
                  ...
                  <div class="clearfix"></div>
                  <textarea class="small-height message" name="edit_private_message_offensive_words" id="edit_private_message_offensive_words" placeholder="<?php echo $this->lang->line("Type your message here...Keep it blank for no actions") ?>" style="height:140px !important;"></textarea>
        ...
        <div class="row" style="padding: 10px 20px 10px 20px;">
          ...
          <?php for($i=1;$i<=20;$i++) :?>
            <div class="form-group" id="edit_filter_div_<?php echo $i; ?>" style="border: 1px dashed #ccc; padding: 10px; margin-bottom: 50px;">
              <label>
                <i class="fa fa-tag"></i> <?php echo $this->lang->line("filter word/sentence") ?> <span class="red">*</span>
