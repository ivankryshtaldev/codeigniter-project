	        ...
	        <div class="card">
	          <div class="card-body data-card">
	          	<div class="input-group mb-3" id="searchbox">
	          	    ...
	          	    <input type="text" class="form-control" id="campaign_name" autofocus placeholder="<?php echo $this->lang->line('Search...'); ?>" aria-label="" aria-describedby="basic-addon2" value="<?php if($post_id != 0) echo $post_id; ?>">
    ...
    <div class="modal-dialog modal-mega">
        <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title"><i class="fas fa-reply-all"></i> <?php echo $this->lang->line("Report of Auto Reply");?></h5>
