	...
	<div class="modal-dialog modal-lg" style="min-width: 70%;">
		<div class="modal-content">
			...
			<div class="modal-header">
			  <h5 class="modal-title" style="padding: 10px 20px 10px 20px;" ><?php echo $this->lang->line("Please give the following information for post auto comment") ?></h5>
				...
				<div class="row" style="padding: 20px;">
					...
					<div class="col-12" style="margin-top: 15px;">
						<div class="form-group">
							...
							<br>
							<input class="form-control" type="text" name="auto_campaign_name_template" id="auto_campaign_name_template" placeholder="Write your auto reply campaign name here">
						</div>
					</div>
					<div class="col-12">
						<div class="form-group" style="padding: 0;">
							...
							<br>
							<select  class="form-control select2" style="width:100%;" id="auto_comment_template_id" name="auto_comment_template_id">
							<?php
					...
					<div class="col-12">
						...
						<div class="row">							
							...
							<div class="form-group schedule_block_item col-12 col-md-6">
								...
								echo form_dropdown('time_zone',$time_zone,set_value('time_zone'),' class="form-control select2" id="time_zone" required style="width:100%;"');
								?>
							</div>
						</div>

						<div class='schedule_block_item_new' style="padding:30px 30px 20px 30px !important; border:1px solid #f9f9f9 !important; background: #FAFDFB !important;">
							...
							<div class="row">								
								<div class="form-group schedule_block_item_new col-12 col-md-6">
									...
									echo form_dropdown('periodic_time',$periodic_time,set_value('periodic_time'),' class="form-control select2" id="periodic_time" required style="width:100%"');
									?>
								</div>
								<div class="form-group schedule_block_item_new col-12 col-md-6">
									<label><?php echo $this->lang->line('Time zone'); ?></label>
									<?php
									$time_zone[''] =$this->lang->line('Please Select');
									echo form_dropdown('periodic_time_zone',$time_zone,set_value('periodic_time_zone'),' class="form-control select2" id="periodic_time_zone" style="width:100%" required');
									?>
								</div>
							</div>
