...
?>
        <div class="card-body">
          <div class="col-12" id="fb_sign_up" style="max-width: 250px;">
        ...
        <div class="card-footer">
          <div class="custom-control custom-checkbox">
            <input type="checkbox" name="check_agree" required class="custom-control-input" id="check_agree">

            <label class="custom-control-label" for="check_agree">
              <span ><?php echo $this->lang->line("I check_agree with the"); ?></span>
              <a id="btn_terms" href="#"><?php echo $this->lang->line("terms and conditions"); ?></a>
              <span ><?php echo $this->lang->line(" &"); ?></span>
              <a id="btn_privacy" href="#"><?php echo $this->lang->line("privacy policy"); ?></a>
            </label>

            <p id="terms_error" class="text-danger"><?php echo $this->lang->line("Please check terms of service and the privacy policy."); ?> </p>
          </div>
        </div>
      </div>
    </div>
...
$('document').ready(function(){
  ...
  $("#fb_sign_up").click(function(e){
    if ($('#check_agree').prop('checked') == false) {
      e.preventDefault();
      $('#terms_error').show();
    }
  });
