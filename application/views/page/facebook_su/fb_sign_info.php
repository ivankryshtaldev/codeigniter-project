  ...
  <div class="row">
    <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
      <div class="card card-primary login-style" style="border-top: none;">
        ...
        <div class="card-body">
          <form method="POST" action="<?php echo site_url('home/fb_sign_action'); ?>">
            <div class="row">
            ...
            <div class="row">
              <div class="form-group col-6">
                <label for="fb_bname"><?php echo $this->lang->line("Business Name"); ?> </label>
                <input id="fb_bname" type="text" class="form-control" name="fb_bname" autofocus>
              </div>
              <div class="form-group col-6">
                <label for="fb_btype"><?php echo $this->lang->line("Business Type"); ?> </label>
                <input id="fb_btype" type="fb_btype" class="form-control" name="fb_btype" placeholder="<?php echo $this->lang->line("e.g. Restaurant"); ?>" >
              </div>
            </div>
            <div class="row">
            ...
            <div class="form-group">
              <button type="submit" id="fb_sub_continue" class="btn btn-primary btn-lg btn-block">
...
$('document').ready(function(){
  $('#fb_sub_continue').click(function (e) {
    if ($('#fb_bname').val() === "" || $('#fb_btype').val() ==="" ) {
      e.preventDefault();
...
<script>
  $('document').ready(function(){
    ...
    var manualUploader = new qq.FineUploader({
        ...
        request: {
            endpoint: '<?php echo base_url(); ?>2/upload_menu_files',
