    ...
    $(document).on('click','#submit',function(e){   
      ...
      var queryString = new FormData($("#messenger_bot_form")[0]);
        $.ajax({
          ...
          success:function(response){
            $(this).removeClass('btn-progress');
           //  iziToast.success({title: '',message: "<?php echo $this->lang->line('Bot reply has been added successfully.'); ?>",position: 'bottomRight'});
          	// location.reload();
            // $("#bot_list_datatable").show();
