...
<?php
  ...
  if($this->session->userdata('user_type') == 'Member' && in_array(198,$this->module_access))  $level1=2;
  else $level1=3;
...
<script type="text/javascript">
  ...
  var text_with_button_counter_level1 = <?php echo $text_with_button_counter_level1_js; ?>; // initialize level 1 menu count var
  ...
  $(document).on('click','#submit',function(e){   
      ...
      var queryString = new FormData($("#messenger_bot_form")[0]);
        $.ajax({
          type:'POST' ,
          url: base_url+"messenger_bot/edit_persistent_menu_action",
          data: queryString,
          dataType : 'JSON',
          // async: false,
          cache: false,
...
<style type="text/css">
  ...
  .modal-body h1{width:100%;margin:10px 0;font-size:20px;}
  ...
  <div class="modal-dialog modal-lg" style="max-width: 100%">
    <div class="modal-content no_shadow">
      ...
      <div class="modal-header">
        <h5 class="modal-title"><i class="fa fa-edit"></i> <?php echo $this->lang->line("Edit Persistent Menu");?> [<a href="https://facebook.com/<?php echo $page_info['page_id'];?>"><?php echo $page_info['page_name'];?></a>]</h5>
      ...
      <div class="modal-body padding-0">
        <form id="messenger_bot_form">
          ...
          <textarea id="current_postbacks" name="current_postbacks" class="hidden"><?php echo $xdata["poskback_id_json"];?></textarea>
          ...
          { ?>
              ...
              <div class="col-6 col-md-4">
                <div class="form-group">
                  ...
                  <select class="form-control" id="composer_input_disabled" name="composer_input_disabled">
                    <option <?php if($xdata["composer_input_disabled"]=='1') echo 'selected';?> value="1"><?php echo $this->lang->line("Yes"); ?></option>
                    <option <?php if($xdata["composer_input_disabled"]=='0') echo 'selected';?> value="0"><?php echo $this->lang->line("No"); ?></option>
                  </select>
                </div>
              </div>              
            ...
            { 
              ...
              ?>       
                ...
                <div class="card card-primary level1<?php if(!isset($item_json_array["call_to_actions"][$i])) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>">
                  <div class="card-header">
                    <h4 class="full_width level1_title">
                      <?php echo $this->lang->line("level-1 menu");?>
                    </h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-12 col-md-4">
                        <div class="form-group">
                          <input value="<?php echo $level1_xtitle;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("menu title"); ?>" name="text_with_buttons_text_<?php echo $i; ?>" id="text_with_buttons_text_<?php echo $i; ?>">
                        </div>
                      </div>
                      <div class="col-4 col-md-4">
                        <div class="form-group">
                          <select class="form-control text_with_button_type_class_level1" id="text_with_button_type_<?php echo $i; ?>" name="text_with_button_type_<?php echo $i; ?>">
                            ...
                            <option <?php if($level1_xtype=='web_url') echo 'selected';?> value="web_url"><?php echo $this->lang->line("Web URL"); ?></option>
                            <option <?php if($level1_xtype=='post_back') echo 'selected';?> value="post_back"><?php echo $this->lang->line("Post Back"); ?></option>
                            <option <?php if($level1_xtype=='nested') echo 'selected';?> value="nested"><?php echo $this->lang->line("Nested"); ?></option>
                          </select>
                        </div>
                      </div>
                      <div class="col-8 col-md-4">
                        <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>" <?php if($level1_xtype!='post_back') echo 'style="display: none;"'; ?>>
                        ...
                        <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>" <?php if($level1_xtype!='web_url') echo 'style="display: none;"'; ?>>
                          <input value="<?php echo $level1_xurl;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("web url"); ?>" name="text_with_button_web_url_<?php echo $i; ?>" id="text_with_button_web_url_<?php echo $i; ?>">
                        </div>
                      </div>
                    </div>              
                  <?php
                  ...
                  { 
                    ...
                    ?>
                      ...
                      <div class="card card-warning level2<?php if(!isset($item_json_array["call_to_actions"][$i]["call_to_actions"][$j])) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                          ...
                          <div class="row">
                            <div class="col-12 col-md-4">
                              <div class="form-group">
                                <input value="<?php echo $level2_xtitle;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("menu title"); ?>" name="text_with_buttons_text_<?php echo $i;?>_<?php echo $j;?>" id="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j;?>">
                              </div>
                            </div>
                            <div class="col-4 col-md-4">
                              <div class="form-group">
                                <select class="form-control text_with_button_type_class_level2" id="text_with_button_type_<?php echo $i; ?>_<?php echo $j;?>" name="text_with_button_type_<?php echo $i; ?>_<?php echo $j;?>">
                                  <!-- <option value=""><?php echo $this->lang->line('please select a type'); ?></option> -->
                                  <option <?php if($level2_xtype=='web_url') echo 'selected';?> value="web_url"><?php echo $this->lang->line("Web URL"); ?></option>
                                  <option <?php if($level2_xtype=='post_back') echo 'selected';?> value="post_back"><?php echo $this->lang->line("Post Back"); ?></option>
                                  <option <?php if($level2_xtype=='nested') echo 'selected';?> value="nested"><?php echo $this->lang->line("Nested"); ?></option>
                                </select>
                              </div>
                            </div>
                            <div class="col-8 col-md-4">
                              <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j;?>" <?php if($level2_xtype!='post_back') echo 'style="display: none;"'; ?>>
                              ...
                              <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>_<?php echo $j;?>" <?php if($level2_xtype!='web_url') echo 'style="display: none;"'; ?>>
                                <input value="<?php echo $level2_xurl;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("web url"); ?>" name="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j;?>" id="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j;?>">
                              </div>
                            </div>
                          </div>
                        <?php
                        ...
                        { 
                          ...
                          ?>
                          <div class="card card-secondary level3<?php if(!isset($item_json_array["call_to_actions"][$i]["call_to_actions"][$j]["call_to_actions"][$k])) echo ' hidden';?>" id="text_with_buttons_row_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>">
                            <div class="card-header">
                            ...
                            <div class="card-body">
                              ...
                              <div class="row">
                                <div class="col-12 col-md-4">
                                  <div class="form-group">
                                    <input value="<?php echo $level3_xtitle;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("menu title"); ?>" name="text_with_buttons_text_<?php echo $i;?>_<?php echo $j;?>_<?php echo $k;?>" id="text_with_buttons_text_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>">
                                  </div>
                                </div>
                                <div class="col-4 col-md-4">
                                  <div class="form-group">
                                ...
                                <div class="col-8 col-md-4">
                                  <div class="form-group" id="text_with_button_postid_div_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" <?php if($level3_xtype!='post_back') echo 'style="display: none;"'; ?>>
                                    <?php 
                                  ...
                                  <div class="form-group" id="text_with_button_web_url_div_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" <?php if($level3_xtype!='web_url') echo 'style="display: none;"'; ?>>
                                    <input value="<?php echo $level3_xurl;?>" type="text" class="form-control" placeholder="<?php echo $this->lang->line("web url"); ?>" name="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>" id="text_with_button_web_url_<?php echo $i; ?>_<?php echo $j;?>_<?php echo $k;?>">
                                  </div>
                                </div>
                              </div>
                        ...
                        <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right level3_add <?php echo $level3_add_hide;?>" id="add_more_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-3 menu"); ?></a>
                        <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right level3_remove  <?php echo $level3_remove_hide;?>" id="remove_menu_<?php echo $i?>_<?php echo $j?>"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
                        <div class="clearfix"></div>
                  ...
                  <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right level2_add <?php echo $level2_add_hide;?>" id="add_more_<?php echo $i?>"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-2 menu"); ?></a>
                  <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right level2_remove <?php echo $level2_remove_hide;?>" id="remove_menu_<?php echo $i?>"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
                  <div class="clearfix"></div>
            ...
            <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right <?php if($text_with_button_counter_level1_js>=$level1) echo 'hidden';?>" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-1 menu"); ?></a>
            <a href="#" style="border-radius: 0;margin-right:2px;" class="btn btn-sm btn-outline-danger float-right <?php if($text_with_button_counter_level1_js<=1) echo 'hidden';?>" id="remove_menu"><i class="fa fa-remove"></i> <?php echo $this->lang->line("remove"); ?></a>
            <div class="clearfix"></div>
