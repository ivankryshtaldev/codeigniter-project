      ...
      <div class="modal-body padding-0">
        <form id="messenger_bot_form">
          ...
          { ?>
            ...
            <a href="#" style="border-radius: 0;" class="btn btn-sm btn-outline-primary float-right" id="add_more"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("level-1 menu"); ?></a>
